...
import { FaHeartbeat, FaMedkit, FaCommentMedical, FaClinicMedical, FaFacebookF, FaTwitter, FaLinkedinIn } from "react-icons/fa";
		...
		<Section background="linear-gradient(264.47deg, #000848 29.39%, #000848 93.49%)" padding="36px 0 80px 0" quarkly-title="HeroBlock" md-padding="36px 0 60px 0">
			...
			>
				<Image
					...
					src="https://images.unsplash.com/photo-1672518521211-745af8bccd84?ixlib=rb-4.0.3&q=80&fm=jpg&crop=entropy&cs=tinysrgb&h=2000"
